		...
		<main id="main_contents">
				...
				<form action="kenshop" method="post">
					<table>
						<tr>
							...
							<td><input type="submit" name="search" value="検索"> <input
								type="hidden" name="act" value="search"></td>
						</tr>
					</table>
				</form>
			</section>
			<section>
				...
				<table class="selected_item">
					<tr>
						<td>選択商品 <c:out value="${sessionScope.cart.size()}"
								default="0" /> 個
						</td>
						<td>
							<form action="kenshop" method="post">
			...
			<section>
				...
				<c:if test="${not empty table_items}">

					<c:forEach var="item" items="${table_items}">
						<form action="kenshop" method="post">
							<table class="items">
							<tr>
								<td class="lineup_img">
								...
								<td class="lineup">${item.getItemName()}&nbsp;&nbsp;
									${item.getItemArtist()}&nbsp;&nbsp;
								...
								<td class="lineup_btn">
									...
									<input type="hidden" name="act" value="add"> <input
										...
										type="hidden" name="name" value="${item.getItemName()}">
									<input type="hidden" name="artist"
										value="${item.getItemArtist()}"> <input type="hidden"
										name="price" value="${item.getItemPrice()}">
								</td>
								</tr>
							</table>
						</form>

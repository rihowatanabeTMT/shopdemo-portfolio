...
<body id="mycart_page">
	<div id="wrap">
					...
					<c:forEach var="item" items="${cart}" varStatus="status">
						<form action="kenshop" method="post">
							<div class="items">
								...
								<div class="lineup_btn"><input type="submit" value="取り消し">
									<input type="hidden" name="act" value="remove"> <input
									type="hidden" name="remove" value="${status.index}"></div>
							</div>
						</form>
					</c:forEach>
				</div>
			...
			<form action="kenshop" method="post">
				<p>
					↓↓上記の内容で注文画面へ進む場合はこちら↓↓<br> <input type="image"
						src="img/btn_confirmation.gif" alt="戻る">
				</p>
		...
		<div id="sub_contents">
			...
			<p>
				<a href="#"><img src="img/btn_cart.gif" width="146" height="20"
					alt="カートの中身をみる"> </a>
			</p>
			<h4>
